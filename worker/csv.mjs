...
export const styleKeywords = {
  ...
  engraving: "vintage 1800s engraving and woodcut illustration, intricate pen and ink cross-hatching and etched line work, aged paper texture, muted limited palette of sepia, ochre, rust, olive and slate blue, dramatic chiaroscuro lighting, Renaissance and classical antiquity setting, philosophers, nobles, scholars, kings and historical figures in period dress, serious moody cinematic and allegorical, richly detailed hand drawn illustration, balanced composition showing the figures within the scene, not photorealistic, not a photograph, no text or words in the image"
};
