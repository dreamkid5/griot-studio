...
export const styleKeywords = {
  ...
  engraving: "in the style of a Gustave Dore and Albrecht Durer engraving, exquisite fine ink linework and intricate cross-hatching, sharp coherent faces and hands, deep dramatic chiaroscuro lighting, aged sepia paper, muted sepia and ochre tones, antique masterful etching, Renaissance and classical antiquity setting, richly detailed, not photorealistic, not a photograph, no text or words in the image"
};
